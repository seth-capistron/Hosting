...
using static Microsoft.AspNetCore.Hosting.ManagedLoadContext;

namespace Microsoft.AspNetCore.Hosting
{
    internal class ManagedLoadContextBuilder
    {
        ...
        public ManagedLoadContextBuilder SetBaseDirectory(string path)
        {
            ...
            {
                throw new ArgumentException(Resources.Error_NullOrEmpty, nameof(path));
            }
        ...
        private static void ValidateRelativePath(string probingPath)
        {
            ...
            {
                throw new ArgumentException(Resources.Error_NullOrEmpty, nameof(probingPath));
            }
